...
const Hero = ({ handleStartPopping }) => {
  return (
    ...
    <section className="relative w-full h-[80vh] flex items-center justify-center text-center bg-gradient-to-br from-[#1C1C3C] to-[#2C2C5C] text-white px-4 py-12 md:py-24">
      <div className="z-10 max-w-2xl mx-auto flex flex-col items-center">
        
        {/* Main headline */}
        <h1 className="text-[32px] sm:text-[40px] md:text-[48px] lg:text-[64px] font-bold mb-4 text-yellow-400 leading-tight">
        ...
        <div className="w-full max-w-xl mb-8 animate-fade-in px-2 sm:px-0">
          <SearchBar />
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button
            className="w-full sm:w-auto px-6 py-3 bg-yellow-400 text-[#1C1C3C] font-semibold rounded hover:bg-yellow-300 transition"
          ...
          <button
            ...
            className="w-full sm:w-auto px-6 py-3 border border-yellow-400 text-yellow-400 font-semibold rounded hover:bg-yellow-400 hover:text-[#1C1C3C] transition"
          >
            Start Popping
          </button>
        </div>
